  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (success) {
      toast({
        ...
        description: "Welcome to Vendor Surplus Exchange. You can now add products.",
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="mx-auto w-16 h-16 bg-gradient-to-br from-primary to-primary-glow rounded-2xl flex items-center justify-center mb-4">
          ...
          <p className="text-muted-foreground mt-2">Create your vendor account</p>
        </div>
        ...
        <Card className="backdrop-blur-sm bg-card/80 border border-border/50">
          <CardHeader>
            ...
            <CardDescription>
              Join our marketplace and start selling your surplus inventory
            </CardDescription>
          </CardHeader>
          <CardContent>
